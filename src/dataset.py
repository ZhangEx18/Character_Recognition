...
def get_train_transform(image_size: int = 64) -> transforms.Compose:
    ...
    【增强策略】：
    通过引入受控的空间几何扰动 (旋转、平移、缩放、透视、弹性变形)，强制网络学习目标的全局拓扑结构特征，
